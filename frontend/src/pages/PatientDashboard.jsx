...
function PatientDashboard() {
  ...
  const handleAnalyzeSymptoms = () => {
    ...
    alert("AI symptom analysis will be connected next.");
  };
      ...
      <aside className="patient-sidebar">
        <div className="patient-brand">
          <div className="brand-logo-circle">
            <svg className="brand-logo-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" />
              <polyline points="2 13 5 13 7 9 9 17 11 13 14 13" strokeWidth="1.4" />
            </svg>
          </div>
          <div className="brand-name">Medi<span>Flow</span> AI</div>
        </div>
        ...
        <div className="patient-header-title">
          <span className="patient-header-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/>
              <polyline points="2 13 5 13 7 9 9 17 11 13 14 13" strokeWidth="1.5" />
            </svg>
          </span>
      ...
      <main className="patient-main">
        <section className="patient-content">
          ...
          <div className="patient-stats">
            <div className="patient-stat-card upcoming-card">
              ...
              <div className="stat-information">
                <span>Upcoming</span>
                <strong>{loading ? "..." : (patient?.upcoming_appointments ?? 0)}</strong>
            ...
            <div className="patient-stat-card completed-card">
              ...
              <div className="stat-information">
                <span>Completed</span>
                <strong>{loading ? "..." : (patient?.completed_appointments ?? 0)}</strong>
                <small>Appointments</small>
              </div>
            </div>
          </div>
          ...
          <section className="symptom-section">
            ...
            <button className="analyze-button" onClick={handleAnalyzeSymptoms}>
              Analyze Symptoms
            ...
            <div className="ai-information">
              ...
              <p>Our AI analyzes your symptoms and suggests the right department and doctor.</p>
            </div>
          </section>
